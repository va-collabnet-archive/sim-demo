...
@ActionRegistration(iconBase = "gov/va/sim/demo/database-import.png",
            ...
            while (expressionItr.hasNext()) {
                ...
                if (cnid == Integer.MIN_VALUE) {
                    ...
                    if (expression.getFocus() != null && expression.getFocus().getValue() != null) {
                        ...
                        System.out.println("FAIL: Focus of expression (or it's value) is null... Will not make concept. ");
                    }
                }
