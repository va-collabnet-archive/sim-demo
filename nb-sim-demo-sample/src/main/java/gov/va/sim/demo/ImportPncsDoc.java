        ...
        try {
            ...
            while (domNode != null) {
                ...
                if (domNode.getNodeName().equals("section")) {
                    ...
                    if (attr.getTextContent().equals("Section=Header")) {
                        headerSection = true;
                    } else {
                        if (headerSection) {
                            headerSection = false;
                            ...
                            providerUuid = Type5UuidFactory.get(UUID.fromString("59c115d0-79c5-11e1-b0c4-0800200c9a66"), authorName);
                            patientUuid = Type5UuidFactory.get(UUID.fromString("59c115d2-79c5-11e1-b0c4-0800200c9a66"), patientIEN);
                            timestamp = sdf.parse(documentTimestamp);
                            String intervalStart = timestamp.toString();
                            String intervalEnd = timestamp.toString();
                            intervalUuid = Type5UuidFactory.get(UUID.fromString("6703d801-7b54-11e1-b0c4-0800200c9a66"), intervalStart + intervalEnd);
                            documentUuid = Type5UuidFactory.get(UUID.fromString("59c115d3-79c5-11e1-b0c4-0800200c9a66"), authorName + patientIEN + intervalUuid.toString());
                    ...
                    if (pcnsLegoMap != null) {
                        ...
                        if (documentUuid != null) {
                            ...
                            UUID assertionUuid = Type5UuidFactory.get(
                                    UUID.fromString("c7a482e1-7b90-11e1-b0c4-0800200c9a66"), 
